...
print("\n── تنظيف الوثيقة النهائية ──")
# ظهرا في وثيقة فعلية أثناء تشغيل الدورة كاملة، لا في اختبار مصنوع.
_M = "⟦BH:law:36/2012:م99⟧"
check("علامة أول السطر لا تترك مسافة بادئة",
      citation.render_clean(f"سطر\n{_M} تقرر للعامل"), "سطر\nتقرر للعامل")
check("وتداخل القوائم يبقى",
      citation.render_clean("1. طلب\n    - فرعي\n        - أعمق"),
      "1. طلب\n    - فرعي\n        - أعمق")
check("والمسافات داخل السطر تُطوى",
      citation.render_clean("نص  فيه   فراغ ،ونقطة"), "نص فيه فراغ،ونقطة")
check("ولا مسافة آخر السطر", citation.render_clean(f"نص {_M}  \nتالٍ"), "نص\nتالٍ")
